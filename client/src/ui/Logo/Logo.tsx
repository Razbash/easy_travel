...
const Logo = () => {
    return(
        <Link to={"/"} className="logo">
            <svg className="logo__image" viewBox="-36 -36 432.03 432.03">
                <rect x="-36" y="-36" width="432.03" height="432.03" rx="216.015" fill="currentColor" strokeWidth="0"/>
                <g>
            ...
            <h2 className="logo__text">Easy Travel</h2>
        </Link>
    )
}
